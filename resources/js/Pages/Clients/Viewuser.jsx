        ...
        >
            ...
            <div className="main-content-container sm:ml-52">
                <div className="mx-auto py-6 flex justify-between flex-col md:flex-row gap-2">
                    <p className='flex flex-wrap'><Link href={route('dashboard')}>Dashboard</Link>  <FiChevronRight size={24} color="black" /> <Link href={route('clients.index')}> Clients Management</Link>  <FiChevronRight size={24} color="black" /> <span className='text-red'>View Client</span></p>

                    <Link
                        href={route('clients.index')}  // Use the correct path to navigate to the users page
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg min-h-[80vh]">
                        <div className="p-6 text-gray-900">
                            <div className='top-search-bar-box flex py-4'>
                                <h2 className='mb-6 text-2xl font-bold text-gray-800'>View Client: <span className='font-normal'>{data.name || 'N/A'}</span></h2>
