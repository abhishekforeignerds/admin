                ...
                <div className="mx-auto py-6">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg min-h-[80vh]">
                        <div className="p-6 text-gray-900">
                            <h1 className="mb-6 text-2xl font-bold text-gray-800">View Finish Goods #{data.material_code}</h1>
                            ...
                            <div>
                                <div className="bg-lightGrayTheme p-4 mt-4">
                                    ...
                                    <div className='grid md:grid-cols-2 grid-cols-1'>
                                        ...
                                        {/* 
                                        <div className="mb-2 flex items-center gap-1">
                                            <p className="text-md font-semibold text-gray-700">Quantity Reserved:</p>
                                            <p className="text-gray-800">{data.buffer_stock || "N/A"} {data.unit_of_measurement || "N/A"}</p>
                                        </div> */}
                                        <div className="mb-2 flex items-center gap-1">
                                            <p className="text-md font-semibold text-gray-700">Level Threshold:</p>
                                            <p className="text-gray-800">{data.reorder_level || "N/A"} {data.unit_of_measurement || "N/A"}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
