...
const RecentGameResults = ({ gameResults }) => {
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6 min-w-[100%] sm:max-w-[100%] overflow-x-auto sm:[overflow-x-scroll]">
      ...
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="text-sm text-red">
            ...
            {/* <th className="p-2 border-b">Winning Number</th>
            <th className="p-2 border-b">Lose Number</th> */}
          ...
          <tr className="text-xs">
            ...
            <th className="p-2 border-b">
              <input
                type="text"
                value={columnFilters.winning_number}
                onChange={(e) => handleFilterChange(e, 'winning_number')}
                placeholder="Search"
          ...
          {paginatedResults.length ? (
            paginatedResults.map((record, index) => (
              <tr key={index} className="hover:bg-gray-50 text-sm">
                ...
                {/* <td className="p-2 border-b">{record.winning_number ?? "---"}</td>
                <td className="p-2 border-b">{record.lose_number ?? '---'}</td> */}
