...
const RecentClientorders = ({ orders }) => {
            ...
            <table className="w-full text-left border-collapse">
                <thead>
                    <tr className="text-sm">
                        ...
                        <th className="p-2 border-b text-red font-bold">Date Created</th>
                        <th className="p-2 border-b text-red font-bold">Status</th>
                        <th className="p-2 border-b text-red font-bold">Delivery Date</th>
...
export default RecentClientorders;
