...
const RecentVendororders = ({ vendorpurchaseOrders }) => {
            ...
            <table className="w-full text-left border-collapse">
                <thead>
                    <tr className="text-sm">
                        ...
                        <th className="p-2 border-b text-red font-bold">PO Date</th>
                        <th className="p-2 border-b text-red font-bold">Invoice Status</th>
                        ...
                        selectedOrders.map((order) => (
                            ...
                            < tr key={order.id} className="hover:bg-gray-50 text-sm" >
                                ...
                                <td className="p-2 border-b">
                                    {order.invoice_file ? 'Uploaded' : 'Not Uploaded'}
                                </td>
